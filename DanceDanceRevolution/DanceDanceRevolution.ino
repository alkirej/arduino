...
#define UP_ARROW_PIN    6
#define CORNER_A_PIN    2
#define RIGHT_ARROW_PIN 3
#define DOWN_ARROW_PIN  4
#define LEFT_ARROW_PIN  5
#define CORNER_B_PIN    9

#define UP_ARROW_KEY    KEY_UP_ARROW
#define CORNER_A_KEY    KEY_LEFT_CTRL
#define RIGHT_ARROW_KEY KEY_RIGHT_ARROW
#define DOWN_ARROW_KEY  KEY_DOWN_ARROW
#define LEFT_ARROW_KEY  KEY_LEFT_ARROW
#define CORNER_B_KEY    KEY_LEFT_ALT
